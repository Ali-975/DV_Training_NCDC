...
int main() {
    ...
    com_emp* c = &b; // Commission Employee's object
    ...
    cout << endl << "Earnings using base class reference to derived object: " << c->earnings() << endl;

    // Which class method is called?
    cout << endl << "Called method: [bs_com_emp::earnings] (via virtual function)" << endl << endl;
