...
bool check_password(const char *first_name, const char *last_name, const char *password) {
    ...
    // assert(lower);
    // printf("Congrats! The lower test case is now passing.\n");

    length = check_length(password);
    // assert(length);
    // printf("Congrats! The length test case is now passing.\n");

    name = check_name(first_name, last_name, password);
    // assert(name);
    // printf("Congrats! The name test case is now passing.\n");

    number = check_number(password);
    // assert(number);
    // printf("Congrats! The number test case is now passing.\n");

    upper = check_upper(password);
    // assert(upper);
    // printf("Congrats! The upper test case is now passing.\n");
